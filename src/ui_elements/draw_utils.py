...
def draw_node(surface: pygame.Surface, camera: Camera, node: Point):
...
def draw_signal(surface: pygame.Surface, camera: Camera, alignment: PointWithDirection, color=WHITE):

...
class SignalPanelContent:
    """Signal control panel with no additional options.
    """
    def __init__(self, surface: pygame.Surface, rect: pygame.Rect) -> None:
        ...
        self.title_surface = self.title_font.render("Signal Control", True, YELLOW)
        self.label_surface = self.data_font.render("Click to place signal. Click again to toggle direction.", True, WHITE)

...
class ConstructionCommonView(BaseConstructionView):
    def render(self, screen_pos: Position | None) -> None:
        ...
        for edge, speed in self._simulation.graph.edges_with_data('speed').items():
            ...
            elif self._simulation.platforms.is_edge_platform(edge):
        ...
        for station in self._simulation.stations.all():
            ...
            for middle_point in self._simulation.platforms.platforms_middle_points(station):

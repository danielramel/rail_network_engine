...
\textbf{Megjegyzés:} Az áttekinthetőség érdekében az UML diagramok a lényeges komponensekre összpontosítanak, így nem feltétlenül tartalmazzák a teljes rendszer minden elemét.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{impl/app_architecture/entry_points_uml.png}
    \caption{A program vezérlésének UML osztálydiagramja}
    \label{fig:entry-points-uml}
\end{figure}

\input{impl/app_architecture/core.tex}
\input{impl/app_architecture/shared.tex}
\input{impl/app_architecture/setup_module.tex}
\input{impl/app_architecture/construction_module.tex}
\input{impl/app_architecture/train_placement_module.tex}
\input{impl/app_architecture/simulation_module.tex}
\input{impl/app_architecture/timetable_module.tex}
\input{impl/app_architecture/assets_folder.tex}
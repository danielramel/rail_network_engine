...
A \texttt{timetable} modul biztosítja a vonatmenetrendek teljes körű kezelését, beleértve azok grafikus megjelenítését. Technológiai szempontból ez a modul elkülönül a projekt többi részétől: a grafikus felhasználói felület (GUI) a \texttt{PyQt6} keretrendszer natív widgetjeire épül, kihasználva annak fejlett ablakkezelési és eseményvezérlési képességeit a komplex adatbeviteli feladatokhoz.

...
\newenvironment{TestTable}[1][Teszt táblázat]{
	\def\TestTableCaption{#1}%
	\begin{longtable}{|p{0.21\linewidth}|p{0.21\linewidth}|p{0.26\linewidth}|p{0.26\linewidth}|}
	\hline
	\TestHeader
}{
	\hline
	\caption{\TestTableCaption}\label{tab:test:\thetable}
	\end{longtable}
}
\subsection{Setup modul}
\begin{TestTable}[Setup modul - tesztesetek]
...
\paragraph{Vágányok}
\begin{TestTable}[Vágány építés - tesztesetek]
...
\paragraph{Alagutak}
\begin{TestTable}[Alagút építés - tesztesetek]
...
\paragraph{Jelzők}
\begin{TestTable}[Jelző építés - tesztesetek]
...
\paragraph{Állomások}
\begin{TestTable}[Állomás építés - tesztesetek]
...
\paragraph{Peronok}
\begin{TestTable}[Peron építés - tesztesetek]
...
\paragraph{Pályaelemek törlése}
\begin{TestTable}[Pályaelemek törlése - tesztesetek]
...
\subsection{Vonatelhelyezés}
\begin{TestTable}[Vonatelhelyezés - tesztesetek]
...
\subsection{Vonateltávolítás}
\begin{TestTable}[Vonateltávolítás - tesztesetek]
...
\paragraph{Menetrendek összesítése}
\begin{TestTable}[Menetrendek összesítése - tesztesetek]
...
\subsection{Menetrend szerkesztése}
\begin{TestTable}[Menetrend szerkesztő panel - tesztesetek]
...
\subsection{Simulation mód}
\paragraph{Szimuláció indítása és leállítása}
\begin{TestTable}[Szimuláció indítása/leállítása - tesztesetek]
...
Szimuláció leállítása & Simulation mód fut, nincs folyamatban kritikus művelet & Felhasználó "Leállítás" gombot nyom és megerősít & Idő előrehaladás megáll, mód visszalép konstrukciós módba, vonatok álló státuszra váltanak\\\hline
\end{TestTable}

\paragraph{Időkezelés}
\begin{TestTable}[Időkezelés - tesztesetek]
...
\paragraph{Vonatok}
\begin{TestTable}[Vonatok - tesztesetek]
...
\begin{TestTable}[Jelzők és vágányutak - tesztesetek]
...
\begin{TestTable}[Mentés és betöltés - tesztesetek]
...
\subsection{Kilépés}
\begin{TestTable}[Kilépés - tesztesetek]

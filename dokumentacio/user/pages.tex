...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{user/images/home_page.png}
...
\begin{itemize}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{user/images/input_simulation_time.png}
        \caption{Példa szöveges adatbevitelre}
        \label{fig:input-popup}
    \end{figure}
    \item \textit{Vizuális visszajelzés:} Ha egy elem az adott pozícióban nem helyezhető el (pl. ütközés vagy érvénytelen geometria), a kurzor alatt a terület piros színre vált.
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.4\textwidth]{user/images/alert.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{user/images/project_view.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{user/images/zoomed_in.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{user/images/deleting_track.png} \\[0.5em]
    \includegraphics[width=0.6\textwidth]{user/images/deleting_signal.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{user/images/train_placement.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{user/images/train_deletion.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{user/images/timetable_list.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{user/images/timetable_editor.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{user/images/timetable_editor_selected_station.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{user/images/simulation_page.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{user/images/route_preview.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{user/images/route_before_blockers.png} \\[0.5em]
    \includegraphics[width=0.7\textwidth]{user/images/route_after_blockers.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{user/images/train_panels_late_on_time.png}
